...
public class Main_calendar {
	...
	public static void main(String[] args) {
		...
		// >> 현재시각 1 => Tue Jan 30 12:27:23 GMT+09:00 2024
		
		SimpleDateFormat sdformat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");	
		System.out.println(">> 현재시각 2 => " + sdformat.format(now));		
		// >> 현재시각 2 => 2024-01-30 12:29:01
		...
		currentTime = String.format("%tF %tp", now, now);
		System.out.println(">> 현재시각 3 => " + currentTime);		
		// >> 현재시각 3 => 2024-01-30 오후
		
		currentTime = String.format("%tF %tp %tT", now, now, now);
		System.out.println(">> 현재시각 3 => " + currentTime);		
		// >> 현재시각 3 => 2024-01-30 오후 12:34:25
		
		currentTime = String.format("%tF %tp %tT %tA", now, now, now, now);
		System.out.println(">> 현재시각 3 => " + currentTime);		
		// >> 현재시각 3 => 2024-01-30 오후 12:34:45 화요일
		
		currentTime = String.format("%tF %tp %tT %tA %tZ", now, now, now, now, now);
		System.out.println(">> 현재시각 3 => " + currentTime);		
		// >> 현재시각 3 => 2024-01-30 오후 12:35:06 화요일 GMT+09:00
		// GMT+09:00 ==> 그리니치 천문대 시간보다 9시간 빠르다는 이야기이다.
		...
		try {
	      ...
	      */
			if (date1.before(date2)) {
				...
				System.out.println(
						str_date1 + " 와 " + str_date2 + " 은 동일한 날짜 이거나 " + str_date1 + " 이 " + str_date2 + " 보다 이후날짜 입니다.");
			}
			// 19950704 이 19980301 보다 이전날짜 입니다.
	       ...
	       */
			if (date2.after(date1)) {
				...
				System.out.println(str_date2 + " 와 " + str_date1 + " 은 동일한 날짜 이거나 " + str_date2 + " 이 " + str_date1
						+ " 보다 이전날짜 입니다.");
			}
		...
		System.out.println("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
		   ...
		   */   
			...
			int month = currentDate.get(Calendar.MONTH); // 0 ~ 11 ( 0 == 1월	11 == 12월)
		   ...
		   */
		    ...
		    System.out.println("월(0~11, 0:1월): " + strMonth2);
			/*
			   올 해의 년도 : 2024
			   월(0~11, 0:1월): 01
			 */		    
		    
		    System.out.println("이 해의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_YEAR));	// 올해의 몇째주인지
		    System.out.println("이 달의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_MONTH));	// 이번달의 몇째주인지
			...
			// 오늘은 화요일 입니다. (오늘은 2024-01-30(화요일)이다)
			...
			today += " " + currentDate.get(Calendar.HOUR_OF_DAY) + ":"
					+ (currentDate.get(Calendar.MINUTE) < 10 ? "0" + currentDate.get(Calendar.MINUTE)
							: currentDate.get(Calendar.MINUTE))
					+ ":" + (currentDate.get(Calendar.SECOND) < 10 ? "0" + currentDate.get(Calendar.SECOND)
