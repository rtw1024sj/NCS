...
public class Main_gujikja_company {
	...
	public static void main(String[] args) {
		...
		// ArrayList 를 사용하여 제한없이 저장할 수 있다.
		...
		// 만약 로그인 기능을 사용할 경우 List 를 사용하면 모든 key 값을 찾아야해서 
		// 많은 회원이 있을 경우 어떤 회원은 앞쪽에 있어서 빠르게 로그인되지만 어떤 회원은 오래걸리기 때문에
		// HashMap<key, value>() 기능을 사용하여 key(id) 를 통해 빠르게 찾는다.  
		...
		gu_list.add(gu1);			// gu1 의 값을 ArrayList 에 넣는다.
		gu_map.put("eomjh", gu1);	// "eomjh" 를 key 값으로 해서 gu1 의 값을 HashMap 에 넣는다.
