	...
	public static void main(String[] args) {
		...
		Functional_Area_1 area_obj = new Functional_Area_1() {
			...
			public void area(double x, double y, int type) {
				...
				case 3:
					System.out.println("장축의 반지름" + x + "단축의 반지름" + y + "인 타원원 면적은 :" + (3.141592 * x * y));
					break;
		...
		// 가로10.5세로5.5인 사각형 면적은 :57.75

		area_obj.area(10.5, 5.5, 2);	
		// 밑변10.5높이5.5인 삼각형 면적은 :28.875

		area_obj.area(10.5, 5.5, 3);	
		// 장축의 반지름10.5단축의 반지름5.5인 타원원 면적은 :181.426938
		...
		/*
		  ...
		  사용되고 있는 람다의 근간은 수학과 기초 컴퓨터과학 분야에서의 람다 대수이다. 
		  ...
		  FunctionalInterface(함수형 인터페이스)를 구현한 익명(무명)클래스 객체가 생성되어져 있어야만 한다. 
		...
		*/		
		...
		Functional_Operator_3 annonymous_op2 = (double a, double b, String type) -> {
 		...
 		double opr_result2 = annonymous_op2.operator(20, 10, "-");
		...
		Functional_Operator_3 annonymous_op3 = (a, b, type) -> {
 		...
 		double opr_result3 = annonymous_op3.operator(20, 10, "*");
 		System.out.println(opr_result3); // 200.0
