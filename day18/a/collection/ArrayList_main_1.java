...
public class ArrayList_main_1 {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("my_list 의 크기 : " + my_list.size());	// 배열 [] 에서는 .length 구조체 List 에서는 .size 로 크기를 볼 수 있다.
		// my_list 의 크기 : 0
		...
		my_list.add(new Integer(98)); // The constructor Integer(int) is deprecated since version 9
		// 쓸 수는 있지만 왠만하면 쓰지 말라고한다.
		...
		for(int i = 0; i < 9; i++) {
			System.out.println(my_list.get(i));	// List 내용물 보려면 .get
		} // end of for----------------
		/*
  		    이순신
			엄정화
...
//		mbr_list.add("마동석");
//		mbr_list.add(1234);
//		mbr_list.add(123.456);
		
		for(int i = 0; i < my_list.size(); i++) {
			System.out.println(mbr_list.get(i));
		} // end of for-------------
