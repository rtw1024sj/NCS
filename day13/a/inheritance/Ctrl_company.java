...
public class Ctrl_company extends Ctrl_common{
	...
	public void register(Scanner sc, Company[] cp_arr) {
		...
		else { // 지금까지 생성된 구직인회사 회원수가 cp_arr.length(==>정원) 와 같거나 큰 경우에만 신규회원을 받아들이면 안된다.
	...
	// == 구인회사 메뉴 == //
	public void cp_menu(Scanner sc, Company login_cp, Company[] cp_arr, Gujikja[] gu_arr, Recruit[] rc_arr) {
		
		String str_menuno;
		do {
			System.out.println("\n === 구인회사 전용메뉴("+ login_cp.getName() +" 기업 로그인중) ===\n"
			                 + "1.회사정보 보기   2.회사정보 수정   3.모든구직자 조회    4.구직자성별검색"
			                 + "    5.구직자연령대검색	6.구직자 연령대 및 성별검색	 	7.사원모집공고	"
			                 + "  8.모집공고지원자 조회 	9.로그아웃\n");  
			...
			switch (str_menuno) {
				...
				case "3": // 모든구직자 조회
					view_all_gujikja_info(sc, gu_arr);
					break;	
					
				case "4": // 구직자 성별검색
					view_all_gujikja_gender(sc, gu_arr);
					break;
					
				case "5": // 구직자 연령대검색
					view_all_gujikja_age(sc ,gu_arr);

					break;					
					
				case "6": // 구직자 연령대 및 성별검색
					view_all_gujikja_gender_age(sc ,gu_arr);
					break;					
...
// =======================================================================================	//
	...
	// == 회사정보 수정 == //
	private void update_companyInfo(Scanner sc, Company login_cp) {
...
// =======================================================================================	//	
	...
	private void view_all_gujikja_info(Scanner sc, Gujikja[] gu_arr) {
	...
	private void view_all_gujikja_gender(Scanner sc, Gujikja[] gu_arr) {
	...
	// == 구직자 연령대검색 == //
	private void view_all_gujikja_age(Scanner sc, Gujikja[] gu_arr) {
	...
	}// end of private void view_all_gujikja_age(Scanner sc, Gujikja[] gu_arr) -----------
	// == 구직자 연령대검색 끝 == //
	
	
	
	// == 구직자 연령대,성별 검색 == //
	private void view_all_gujikja_gender_age(Scanner sc, Gujikja[] gu_arr) {
